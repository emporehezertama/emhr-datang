...
{
	$cuti = \App\Models\HistoryApprovalLeave::select('cuti_karyawan.*')->join('cuti_karyawan','cuti_karyawan.id','=','history_approval_leave.cuti_karyawan_id')->orderBy('cuti_karyawan_id', 'DESC');
