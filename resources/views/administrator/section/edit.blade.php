...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.section.update', $data->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                               <select class="form-control" name="directorate_id" required>
                                    ...
                                    <option value="{{ $item->id }}"  {{ $item->id == $data->directorate_id ? 'selected': '' }}>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="division_id">
                                    ...
                                    <option value="{{ $item->id }}" {{ $item->id == $data->division_id ? 'selected': '' }}>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
