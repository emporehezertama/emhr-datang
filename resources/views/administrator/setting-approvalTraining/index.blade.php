...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">SETTING APPROVAL TRAINING</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title m-b-0">SETTING APPROVAL TRAININg</h3>
                    <br />
                            ...
                            <tbody>
                                @foreach($data as $no => $item)
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                            <a href="{{ route('administrator.setting-approvalTraining.indexItem', ['id' => $item->id]) }}"> <button class="btn btn-info btn-xs"><i class="fa fa-arrow-right"></i>Detail</button></a>
