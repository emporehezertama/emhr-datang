...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-md-6">
               <a href="{{ route('administrator.setting-approvalPaymentRequest.createItem', ['id' => $data->id]) }}" class="btn btn-sm btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i class="fa fa-plus"></i> ADD APPROVAL</a>
