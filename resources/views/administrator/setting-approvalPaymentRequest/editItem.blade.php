               ...
               <!-- <input type="hidden" name="_method" value="PUT">-->
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <br />
                        <div class="col-md-12">
                            <a href="{{ route('administrator.setting-approvalPaymentRequest.indexItem',['id' => $data->setting_approval_leave_id] ) }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
