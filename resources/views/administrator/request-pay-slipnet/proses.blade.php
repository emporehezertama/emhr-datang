...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form_payment" method="POST" action="{{ route('administrator.request-pay-slipnet.submit', $datamaster->id) }}">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <a href="{{ route('administrator.request-pay-slipnet.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Back</a>
                        @if($datamaster->status == 1)
                        <button type="submit" class="btn btn-info btn-sm">Proces and Send</button>
                        @endif
                        <div class="clearfix"></div>
                    </div>
                </div>    
