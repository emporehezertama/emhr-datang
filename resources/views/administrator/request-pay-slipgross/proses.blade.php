...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form_payment" method="POST" action="{{ route('administrator.request-pay-slipgross.submit', $datamaster->id) }}">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <hr />
                        <br />
                        <a href="{{ route('administrator.request-pay-slipgross.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Back</a>
