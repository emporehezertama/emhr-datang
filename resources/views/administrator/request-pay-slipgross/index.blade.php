                            ...
                            <tbody>
                                @foreach($data as $no => $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->status == 1)
                                                <a href="{{ route('administrator.request-pay-slipgross.proses', $item->id) }}" class="btn btn-info btn-xs">proses <i class="fa fa-arrow-right"></i> </a>
                                            @else
                                                <a href="{{ route('administrator.request-pay-slipgross.proses', $item->id) }}" class="btn btn-info btn-xs">detail <i class="fa fa-search-plus"></i> </a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endif
