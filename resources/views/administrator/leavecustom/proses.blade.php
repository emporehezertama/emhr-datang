                    ...
                    <div class="white-box">
                        ...
                        <div class="col-md-6" style="padding-left: 0;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" readonly="true" class="form-control jabatan" value="{{ isset($data->karyawan->structure->position) ? $data->karyawan->structure->position->name:''}}{{ isset($data->karyawan->structure->division) ? '-'. $data->karyawan->structure->division->name:''}}">
                                </div>
