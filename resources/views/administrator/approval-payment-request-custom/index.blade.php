                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($item->is_approved === NULL and $item->status < 2)
                                                <a href="{{ route('administrator.approval.payment-request-custom.detail', ['id' => $item->id]) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-arrow-right"></i> process </button></a>
                                            @else
                                                <a href="{{ route('administrator.approval.payment-request-custom.detail', ['id' => $item->id]) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-search-plus"></i> detail </button></a>
                                            @endif
