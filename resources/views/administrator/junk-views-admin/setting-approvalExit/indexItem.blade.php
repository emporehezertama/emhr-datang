                            ...
                            <tbody>
                                @foreach($dataItem as $no => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('administrator.setting-approvalExit.editItem', ['id' => $item->id]) }}" style="float: left; margin-right:5px"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-edit"></i> edit</button></a>
                                            
                                            <form action="{{ route('administrator.setting-approvalExit.destroyItem',['id' => $item->id])}}" onsubmit="return confirm('Delete this data?')" method="post" style="margin-left: 5px;">
                                                {{ csrf_field() }}                                              
