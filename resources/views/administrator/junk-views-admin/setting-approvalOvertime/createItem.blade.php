            ...
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.setting-approvalOvertime.storeItem') }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <br />
                        <div class="col-md-12">
                            <a href="{{ route('administrator.setting-approvalOvertime.indexItem',['id' => $data->id] ) }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
