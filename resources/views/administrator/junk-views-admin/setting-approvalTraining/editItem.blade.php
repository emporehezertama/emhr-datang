        ...
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.setting-approvalTraining.updateItem', $data->id) }}" method="POST">
               <!-- <input type="hidden" name="_method" value="PUT">-->
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Update Approval Training</h3>
                        <hr />
                        @if (count($errors) > 0)
                        ...
                        <br />
                        <div class="col-md-12">
                            <a href="{{ route('administrator.setting-approvalTraining.indexItem',['id' => $data->setting_approval_leave_id] ) }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
