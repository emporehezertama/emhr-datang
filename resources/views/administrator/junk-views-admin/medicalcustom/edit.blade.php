                    ...
                    <div class="white-box">
                        ...
                        <div class="col-md-6" style="padding-left: 0;">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" readonly="" class="form-control" value="{{ isset($data->user->structure->position) ? $data->user->structure->position->name:''}}{{ isset($data->user->structure->division) ? '-'. $data->user->structure->division->name:'' }}">
                                </div>
                            </div>
                            <div class="form-group">
