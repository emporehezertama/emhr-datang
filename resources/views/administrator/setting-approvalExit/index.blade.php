...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title m-b-0">SETTING APPROVAL EXIT INTERVIEW</h3>
                    <br />
                            ...
                            <tbody>
                                @foreach($data as $no => $item)
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                            <a href="{{ route('administrator.setting-approvalExit.indexItem', ['id' => $item->id]) }}"> <button class="btn btn-info btn-xs"><i class="fa fa-arrow-right"></i>Detail</button></a>
