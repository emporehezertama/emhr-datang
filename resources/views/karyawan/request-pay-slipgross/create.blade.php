...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form_payment" enctype="multipart/form-data" action="{{ route('karyawan.request-pay-slipgross.store') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" name="tahun">
                                        ...
                                        @foreach(pay_slip_tahun_historyGross(\Auth::user()->id) as $i)
                        ...
                        <hr />
                        <br />
                        <a href="{{ route('karyawan.request-pay-slipgross.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
